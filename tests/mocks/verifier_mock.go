...
//
//	mockgen -source=../../internal/app/domain/ports/verifier.go -destination=verifier_mock.go -package=mocks
//
...
func (mr *MockSignatureVerifierMockRecorder) VerifySignature(ctx, pubKey, payload, signature any) *gomock.Call {
