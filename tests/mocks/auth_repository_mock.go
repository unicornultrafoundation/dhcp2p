...
func (mr *MockAuthServiceMockRecorder) RequestAuth(ctx, request interface{}) *gomock.Call {
...
func (mr *MockAuthServiceMockRecorder) VerifyAuth(ctx, request interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
